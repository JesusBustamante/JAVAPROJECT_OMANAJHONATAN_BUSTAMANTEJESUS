...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            //SupplierController supplierController = new SupplierController(supplierView, supplierDAO);
            //MedicineController medicineController = new MedicineController(medicineView, medicineDAO, supplierDAO);
                ...
                try {
                    ...
                    switch (option) {
                        ...
                        case 4:
                            ...
                            //showInventoryMenu(medicineController, supplierController);
                            break;
                        case 5:
